...
class AnalysisEngineDownloader {
    constructor(services, engineFolder) {
        ...
        this.platformData = new platformData_1.PlatformData(this.platform, this.services.get(types_1.IFileSystem));
    }
    downloadAnalysisEngine(context) {
        return __awaiter(this, void 0, void 0, function* () {
            const localTempFilePath = yield this.downloadFile();
            try {
                yield this.verifyDownload(localTempFilePath);
                ...
                fs.unlink(localTempFilePath, core_utils_1.noop);
            }
        });
    }
    downloadFile() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tempFile = yield helpers_1.createTemporaryFile(downloadFileExtension);
    ...
    verifyDownload(filePath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(yield verifier.verifyHash(filePath, yield this.platformData.getExpectedHash()))) {
