...
let CodeExecutionHelper = class CodeExecutionHelper {
    constructor(serviceContainer) {
        ...
        this.envVariablesProvider = serviceContainer.get(types_4.IEnvironmentVariablesProvider);
        this.processService = serviceContainer.get(types_2.IProcessService);
    ...
    normalizeLines(code, resource) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const env = yield this.envVariablesProvider.getEnvironmentVariables(resource);
                ...
                const proc = yield this.processService.exec(pythonPath, args, { env, throwOnStdErr: true });
                return proc.stdout;
            }
            catch (ex) {
