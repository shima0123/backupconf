...
let PipEnvService = class PipEnvService extends cacheableLocatorService_1.CacheableLocatorService {
    constructor(serviceContainer) {
        ...
        this.envVarsProvider = this.serviceContainer.get(types_5.IEnvironmentVariablesProvider);
    }
    ...
    checkIfPipFileExists(cwd) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof pipFileName === 'string' && (yield this.fs.fileExistsAsync(path.join(cwd, pipFileName)))) {
                return true;
            }
    ...
    invokePipenv(arg, rootPath) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const env = yield this.envVarsProvider.getEnvironmentVariables(vscode_1.Uri.file(rootPath));
                const result = yield this.process.exec(execName, [arg], { cwd: rootPath, env });
                if (result) {
