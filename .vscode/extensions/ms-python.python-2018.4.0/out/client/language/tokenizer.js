...
class Tokenizer {
    ...
    tryNumber() {
        ...
        if (characters_1.isDecimal(this.cs.currentChar) || this.cs.currentChar === 46 /* Period */) {
            ...
            if (re && re.length > 0 && re[0] && candidate.startsWith(re[0])) {
                this.tokens.push(new Token(types_1.TokenType.Number, start, re[0].length + leadingSign));
    ...
    getStringPrefixLength() {
        if (this.cs.currentChar === 102 /* f */ && (this.cs.nextChar === 39 /* SingleQuote */ || this.cs.nextChar === 34 /* DoubleQuote */)) {
            return 1; // f-string
        }
        if (this.cs.currentChar === 98 /* b */ || this.cs.currentChar === 66 /* B */ || this.cs.currentChar === 117 /* u */ || this.cs.currentChar === 85 /* U */) {
            if (this.cs.nextChar === 39 /* SingleQuote */ || this.cs.nextChar === 34 /* DoubleQuote */) {
                // b-string or u-string
                return 1;
            }
            if (this.cs.nextChar === 114 /* r */ || this.cs.nextChar === 82 /* R */) {
        ...
        return this.cs.currentChar === 39 /* SingleQuote */ || this.cs.currentChar === 34 /* DoubleQuote */ ? 0 : -1;
    }
    getQuoteType() {
