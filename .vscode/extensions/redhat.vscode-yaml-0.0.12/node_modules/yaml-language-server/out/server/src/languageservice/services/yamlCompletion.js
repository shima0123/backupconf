...
class YAMLCompletion {
    ...
    addSchemaValueCompletions(schema, collector, types, separatorAfter) {
    ...
    addDefaultValueCompletions(schema, collector, separatorAfter, arrayDepth = 0) {
    ...
    addEnumValueCompletions(schema, collector, separatorAfter) {
